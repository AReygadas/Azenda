...
<template>
    <header >
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" class="text-sm font-sans leading-6 text-gray-900 font-black">Gestoria</a>
          <a href="#" class="text-sm font-sans leading-6 text-gray-900 font-black">Servicios Juridicos</a>
          <a href="#" class="text-sm font-sans leading-6 text-gray-900 font-black">Socios</a>
          <a href="#" class="text-sm font-sans leading-6 text-gray-900 font-black">Contactanos</a>

        </PopoverGroup>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="/SignIn" class="text-sm font-sans leading-6 text-gray-900">Inicia sesion<span aria-hidden="true">&rarr;</span></a>
        </div>
      </nav>
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-sans leading-7 text-gray-900 hover:bg-gray-50">Inicia Sesion</a>
              </div>
            </div>
          </div>
        </DialogPanel>
