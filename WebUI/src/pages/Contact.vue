...
<template>
    <div class="container d-flex justify-content-center align-items-center">
        <div>
            ...
            <div class="centtr" >
                <a href="https://wa.me/+524494417601?text=Bienvenido,%20a%20Azenda" target="_blank">
                    <v-icon class="icon w" icon="mdi-whatsapp"></v-icon>
                </a>
                <a href="https://m.facebook.com/100063841452274/" target="_blank">
                    <v-icon class="icon f" icon="mdi-facebook"></v-icon>
                </a>
            </div>
        </div>

        <form>
            <h1 class="title text-center mb-4">Contáctanos</h1>
            <div class="form-group position-relative" style="position: relative;">
                <!-- <label for="formName" class="d-block">
                        <v-icon class="icon" icon="$vuetify"></v-icon>
                    </label>
                    <input type="text" id="formName" class="form-control form-control-lg thick" placeholder="Name"> -->
                <v-text-field label="Nombre" variant="solo-filled" prepend-inner-icon="mdi-account"></v-text-field>
            </div>

            <!-- E-mail -->
            <div class="form-group position-relative">
                <v-text-field label="Correo" variant="solo-filled" prepend-inner-icon="mdi-email"></v-text-field>
            </div>

            <!-- Message -->
            <div class="form-group message">
                <v-textarea label="Mensaje" prepend-inner-icon="mdi-message-text-outline"
                    variant="solo-filled"></v-textarea>
            </div>

            <!-- Submit btn -->
            <div class="text-center">
                <button type="submit" class="btn btn-primary" tabIndex="-1">Enviar</button>
            </div>
        </form>
